...
namespace DProtector
{
    ...
    {   
        ...
        {   
            ...
            var adapter = nics.First(o => o.Name == ConnectionName);   
            return adapter == null ? null : string.Empty;
        }   
        /// <summary>   
        /// 设置MAC地址   
        /// </summary>   
        ...
        public static void ChangeMac(string index,string newMac)
        {
            RegistryKey macRegistry = Registry.LocalMachine.OpenSubKey("SYSTEM").OpenSubKey("CurrentControlSet").OpenSubKey("Control")   
        ...
        {   
            ...
            var chars = sn.ToCharArray();
            chars[1] = "26AE"[ro.Next(0, 4)];
